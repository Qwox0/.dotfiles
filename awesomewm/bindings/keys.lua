...
------------------------- {{{ Functions
local function changeClient(action, dir)
    return function()
        awful.client[action].bydirection(dir)
        if client.focus then client.focus:raise() end
    end
end

local function relative_to_word(dx)
