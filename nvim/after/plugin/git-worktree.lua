...
if not require("qwox.util").has_plugins("git-worktree") then return end
...
nmap("<leader>gc", require('telescope').extensions.git_worktree.git_worktrees, {
    desc = "[G]it worktree [C]heckout"
})

nmap("<leader>gn", require('telescope').extensions.git_worktree.create_git_worktree, {
