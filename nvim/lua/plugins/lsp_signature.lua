local function config()
    require("lsp_signature").setup {
        ...
        doc_lines = 0,         -- will show two lines of comment/doc(if there are more than two lines in doc, will be truncated); set to 0 if you DO NOT want any API comments be shown
